...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	// Objects register with a notification center to receive notification (NSNotification)
	//addObserver: self, self, this AppDelegate is registering as the observer
	// selector: specifies the message receiver (this Appdelegate) will send to the observer (this App). THe selector
	//can only have a single argument passed, an instance of NSNotification
	// name: the name of the Notification registered with the observer. ONly notifications with this name will
	// be passed to the observer.
	// object : the object whose notifications the observer wants to receiver.
...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation {
	...
	// Creating Notification object that will have the information that the NSNOtification Center will
